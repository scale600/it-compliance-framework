...
| Document | Description |
|----------|-------------|
| [tprm-case-study.md](../evidence/tprm-case-study.md) | Anonymized case study: Vendor assessment for Trusted Partner qualification |
...
**Wonhee Richard Lee** — Senior Cloud Systems Administrator with deep experience in manufacturing IT/OT compliance. This framework was developed and refined at a manufacturing company, where responsibilities included:
...
- Managing TPRM for software development partners, including a Trusted Developer assessment for a global consumer electronics partner
