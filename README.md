...
This repository publicly documents the **GDPR/CCPA Compliance**, **Annual IT & OT Audit**, and **TPRM (Third-Party Risk Management)** frameworks built at a manufacturing company. It serves as verifiable evidence for the compliance experience listed on my resume.
...
- **TPRM** — Led vendor security assessment for a global consumer electronics partner, achieving "Trusted Software Developer Partner" status and unlocking a multi-million dollar partnership.
